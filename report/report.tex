...
standard test images yield a security gap of approximately $\mathbf{15}$--$\mathbf{18}$\,dB
...
decoder consistently achieves $\approx\!15$--$18$\,dB higher PSNR than the
blind adversary.
...
\begin{table}[H]
  ...
  \begin{tabular}{l
    ...
    \midrule
    camera    & 21.0 & 0.686 & 20.5 & 0.679 & 4.8 & 0.005 & \textbf{+15.7} \\
    astronaut & 18.9 & 0.627 & 19.4 & 0.650 & 4.7 & 0.004 & \textbf{+14.7} \\
    chelsea   & 24.3 & 0.760 & 23.6 & 0.762 & 5.8 & 0.007 & \textbf{+17.8} \\
    \bottomrule
  \end{tabular}
\end{table}
...
optical encryption key, with a security gap of approximately $15$--$18$\,dB
